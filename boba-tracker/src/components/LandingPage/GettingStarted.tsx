...
const GET_STARTED_CONTENT_STYLES = "px-8 text-black-ish mb-16";

const TITLE_SECTION_STYLES = "mt-10 text-5xl text-off-white";

const LOGO_CONTAINER_STYLES =
  "bg-off-white size-[150px] border-2  border-black-ish rounded-[100%] flex shadow-b justify-center";

const PHRASE_SUBHEADER_STYLES = "text-xl mt-6 mb-10 max-w-[300px] font-medium leading-[1.2]";
...
const GET_STARTED_BUTTON_TEXT_STYLES = "text-xl font-black mr-2";
  ...
  return (
    <div className={GET_STARTED_PAGE_STYLES}>
      <div className={GET_STARTED_CONTENT_STYLES}>
        ...
        <Link href="/AboutUs">
          <button className={`${GET_STARTED_BUTTON_STYLES} ${GET_STARTED_PRESSED_BUTTON_STYLES}`}>
            <p className={GET_STARTED_BUTTON_TEXT_STYLES}>Get Started</p>
            <Image 
              src={circle_arrow}
              height={30}
              width={30}
